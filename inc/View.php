...
<div>
    ...
    <div class="" style="padding-bottom:1rem;">
        ...
        <select name="_pmab_meta_type" id="_pmab_meta_type" class="postbox">
            ...
            <option value="all_post" <?php echo pmab_select_checker($_pmab_meta_type, 'all_post'); ?>>All Posts</option>
            <option value="post" <?php echo pmab_select_checker($_pmab_meta_type, 'post'); ?>>Specific Posts</option>
            <option value="category" <?php echo pmab_select_checker($_pmab_meta_type, 'category'); ?>>Posts By Category</option>
            ...
            <option value="all_page" <?php echo pmab_select_checker($_pmab_meta_type, 'all_page'); ?>>All Pages</option>
    ...
    <div style="padding-bottom:1rem;">
        ...
        <select name="_pmab_meta_tag_n_fix" id="_pmab_meta_tag_n_fix" class="postbox col-12">
            ...
            <option value="top_before" <?php echo pmab_select_checker($_pmab_meta_tag_n_fix, 'top_before'); ?>>Top</option>
            <option value="bottom_after" <?php echo pmab_select_checker($_pmab_meta_tag_n_fix, 'bottom_after'); ?>>Bottom</option>
            <option value="h2_after" <?php echo pmab_select_checker($_pmab_meta_tag_n_fix, 'h2_after'); ?>>After Heading</option>
            <option value="p_after" <?php echo pmab_select_checker($_pmab_meta_tag_n_fix, 'p_after'); ?>>After Blocks</option>
        </select>
    </div>
    ...
    <div style="padding-bottom:1rem;">
        ...
        <select name="_pmab_meta_type2" id="_pmab_meta_type2" class="postbox">
            ...
            <option value="post_exclude" <?php echo pmab_select_checker($_pmab_meta_type2, 'post_exclude'); ?>>Specific Posts</option>
            <option value="page_exclude" <?php echo pmab_select_checker($_pmab_meta_type2, 'page_exclude'); ?>>Specific Pages</option>
        </select>
    </div>
